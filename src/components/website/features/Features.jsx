...
const Features = () => {
  return (
    <section className="py-5 py-xl-8" id="features">
      <div className="container">
        <div className="row justify-content-md-center">
          <div className="col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6">
            <h2 className="section-title text-center" data-aos="flip-up">Services</h2>
            <p className="text-secondary mb-5 text-center mt-3" data-aos="flip-up">
      ...
      <div className="container overflow-hidden" data-aos="flip-up" data-aos-duration="1000">
